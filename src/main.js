...
function startStage6Aarti() {
    ...
    // Camera zooms close to front of altar: clear, majestic, 100% unobstructed view of Bappa & Aarti Thali
    cameraCinematicMode = null;
    camera.position.set(0, 1.95, 2.45);
    camera.lookAt(0, 1.48, -0.6);
...
function updateCamera(delta) {
    ...
    // 2. Stage 6 Sacred Aarti Intimate Framing
    if (gameState.stage === 6) {
        const aartiCamPos = new THREE.Vector3(0, 2.15, 2.9);
        camera.position.lerp(aartiCamPos, 0.085);
        const aartiLookTarget = new THREE.Vector3(0, 1.45, -0.6);
